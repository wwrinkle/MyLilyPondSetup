...
melody = {
  \relative c' {
    ...
    r4 ef ef ef | gf2. gf4 | f2. f4 | c'1 | \section \break
    \sectionBox "B"
    r4 d d d | bf bf2. | g2. g4 | ef1 | \break
    r4 g g g | bf bf2 bf4 | g2. g4 | c,1 \section \break
    \sectionBox "A"
    r4 bf bf bf | df2. df4 | c c2. | g'1 | \break
    r4 ef ef ef | gf2. gf4 | f2. f4 | c'1 | \section \break
    \sectionBox "C"
    ef2 ef4 ef | c2. c4 | bf2 bf | g g4 af | \break
    bf ef, f af | g ef f af | g2 c | ef, f | \break
    ef1~ | ef2 r \bar "."
  }
}
...
harmony = \chordmode {
  ...
  ef2:6 f:m7 | g:m7 a:m6 | g:m7 c:m7 | f:m7 bf:7 | ef:6 gf:7 | f:7 e:7 |
}
